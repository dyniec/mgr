...
In this thesis we try to build typed version of such calculus with polymorphic types (similiar to Piróg, Polesiuk and Sieczkowski\cite{typed_equivalence}), but for multipromt delimited continuations. Usually such calculi jump from shift to closest enclosing reset. Here we tried labeling them to allow stacking of different effects.
